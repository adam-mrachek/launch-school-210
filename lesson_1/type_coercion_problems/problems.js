// 1. The result of the following calculation is a string. 
...
// 2. Using the same block of JavaScript, change the addition operator to a multiplication operator and leave x as a string. 
// Will the result be a string or a number?

console.log(x * y);

// The result will be a number because the `*` operator coerces operands into numbers.
...
// 4. You can also use the String constructor to create Strings from numbers. This is a function that takes an argument and converts it to a string. 
// Try it using the previous block of code; wrap each number in a call to String.

// See #3

// 5. The toString method is yet another way to convert values to strings. 
